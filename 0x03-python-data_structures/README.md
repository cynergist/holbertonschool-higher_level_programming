...
## Resources
[3.1.3. Lists](https://docs.python.org/3.4/tutorial/introduction.html#lists) </br >
[Data structures (until 5.3 Tuples and Sequences included)](https://docs.python.org/3.4/tutorial/datastructures.html) </br >
...
12. 12-switch.py // Completes the source code in order to switch value of a and b
...
- Whiteboard first
Write a function in C that checks if a singly linked list is a palindrome. </br >
